    ...
    <q-header elevated class="text-white interFaz" id="header" :style="{ 'background-color': colors }">
      <q-toolbar>
        ...
        <div v-else>
          ...
          <q-item clickable v-if="useLogin.rol === 'Super' || useLogin.usestado === true" v-ripple to="/materialesApoyo">
            <q-item-section avatar>
          ...
          <q-item clickable
          v-if="useLogin.rol === 'Super' || useLogin.usestado === true" v-ripple
            to="/materialesforma">
            <q-item-section avatar>
              <q-icon
        ...
        <q-btn flat round dense v-if="!isInLoginComponent" icon="login" @click="cerrar()">
        </q-btn>
      </q-toolbar>
    </q-header>
