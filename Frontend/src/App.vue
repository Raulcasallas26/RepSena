        ...
        <div v-else>
          <q-btn-dropdown flat round dense v-if="!isInLoginComponent && isMobile" icon="menu"
            ...
            <q-list padding>
              ...
              <q-item clickable
                v-if="useLogin.rol === 'Super' || useLogin.rol === 'Gestor'" v-ripple
                to="/instructores">
                <q-item-section avatar>
                  <q-icon
              ...
              <q-item clickable v-if="useLogin.rol === 'Super' || useLogin.rol === 'Gestor'" v-ripple to="/investigacion">
                <q-item-section avatar>
                  <q-icon name="search" />
                </q-item-section>
    ...
    <q-drawer v-if="!isInLoginComponent && !isMobile" bd=true v-model="drawer" show-if-above :mini="miniState"
      ...
      <q-scroll-area class="fit" :horizontal-thumb-style="{ opacity: 0 }" style="background-color: white">
        <q-list padding>
          ...
          <q-item clickable v-if="useLogin.rol === 'Super' || useLogin.rol === 'Administrador' || useLogin.rol === 'Gestor'" v-ripple to="/niveles">
            <q-item-section avatar>
              <q-icon name="scale" />
            </q-item-section>
            <q-item-section>Niveles de Formación</q-item-section>
          ...
          <q-item clickable v-if="useLogin.rol === 'Super' || useLogin.rol === 'Administrador' || useLogin.rol === 'Gestor'" v-ripple to="/instructores">
            <q-item-section avatar>
              <q-icon
                name="img:data:image/png;base64," />
            </q-item-section>
          ...
          <q-item clickable v-if="useLogin.rol === 'Super' || useLogin.rol === 'Instructor' || useLogin.rol === 'Gestor'"
            v-ripple to="/programas">
            <q-item-section avatar>
              <q-icon name="book" />
            </q-item-section>
            <q-item-section> Programas de Formacion</q-item-section>
          ...
          <q-item clickable v-if="useLogin.rol === 'Super' || useLogin.rol === 'Gestor'" v-ripple to="/materialesApoyo">
            <q-item-section avatar>
              <q-icon name="img:https://cdn-icons-png.flaticon.com/512/1556/1556328.png" />
            </q-item-section>
            <q-item-section>Materiales de apoyo</q-item-section>
          ...
          <q-item clickable v-if="useLogin.rol === 'Super' || useLogin.rol === 'Administrador' || useLogin.rol === 'Gestor'" v-ripple to="/materialesforma">
            <q-item-section avatar>
              <q-icon name="img:https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0weUry8lZ8XTLo1lDruF6i2fzqPOQI7bazPybG7eSWIuVvP1xKhm0plAp8l-pbzC8tMo&usqp=CAU" />
            </q-item-section>
            <q-item-section> Materiales de Formacion </q-item-section>
